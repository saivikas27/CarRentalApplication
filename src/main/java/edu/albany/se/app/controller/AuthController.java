...
public class AuthController
{
	...
	public void update(@RequestParam int id, @RequestParam String firstName, @RequestParam String lastName,@RequestParam int countryId, @RequestParam String licenseNumber, @RequestParam String email)
	{
		UserService userService = new UserService();
		userService.updateUser(id,firstName,lastName,countryId,licenseNumber,email);
	}
